...
// Add this check inside parseTgInitData(), after the HMAC passes:
const authDate = parseInt(params.get('auth_date') || '0', 10);
const AGE_LIMIT = 5 * 60; // 5 minutes
if (Date.now() / 1000 - authDate > AGE_LIMIT) return null;function requireAuth(req, res, next) {
  let tgUser = null;
